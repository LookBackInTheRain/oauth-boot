package club.yuit.boot.handler;


import club.yuit.boot.exception.ArgumentsFailureException;
import club.yuit.boot.exception.AuthFailureException;
import club.yuit.boot.exception.NotAuthException;
import club.yuit.boot.exception.NotAuthorityException;
import club.yuit.boot.response.BaseResponse;
import club.yuit.boot.response.SimpleResponse;
...
import static club.yuit.boot.response.HttpResponse.baseResponse;
import static club.yuit.boot.response.HttpResponse.simpleResponse;
